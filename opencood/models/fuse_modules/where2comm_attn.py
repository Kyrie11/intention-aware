...
'''
从单帧图像/雷达数据预测ego vehicle的下一帧运动，然后得到ego intention query
intention的query和other feature计算一个intention map
'''
...
class TransformerFusion(nn.Module):
    def __init__(self, channels=256, n_head=8, with_spe=True, with_scm=True, dropout=0):
        ...
        self.intention_encoder = IntentionEncoder(channels, n_head, dropout)
